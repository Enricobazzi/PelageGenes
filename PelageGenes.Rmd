...
```{r AGAIN Create a table with the useful SNPs information and annotations, eval=FALSE, engine='bash'}

## Need to divide SNPEFF annotations and custom annotations from the rest of the file since with INDELs included there are compatibility problems between previous script and Database (mainly the commas which are used not only in the ANN= part of the table, but in other parts as well). Squaring SNPEFF annotations was not done, instead they were all included in a single column
...
# convert ',' to ';' to have all SNPEFF ANN in one column of the final table
tr ',' ';' <c_ll_lp_plus_h_ll_polarized.lr_ann.ParentIDsGrep_noIndividuals_nas_annonly_snpeff.vcf > c_ll_lp_plus_h_ll_polarized.lr_ann.ParentIDsGrep_noIndividuals_nas_annonly_snpeff_nocomma.vcf
...
for i in $NoCustomLines
  do
  ed -s c_ll_lp_plus_h_ll_polarized.lr_ann.ParentIDsGrep_noIndividuals_nas_annonly_customonly.vcf < <(printf '%s\n' ${i}i "" . wq)
done
...
# insert EMPTY in empty lines CUSTOM ONLY
sed -i -e 's/^$/EMPTY/' c_ll_lp_plus_h_ll_polarized.lr_ann.ParentIDsGrep_noIndividuals_nas_annonly_customonly_blanklines_condensed.vcf
...
paste -d '\t' c_ll_lp_plus_h_ll_polarized.lr_ann.ParentIDsGrep_noIndividuals_nas_annonly_snpeff_nocomma.vcf c_ll_lp_plus_h_ll_polarized.lr_ann.ParentIDsGrep_noIndividuals_nas_annonly_customonly_blanklines_condensed.vcf > c_ll_lp_plus_h_ll_polarized.lr_ann.ParentIDsGrep_noIndividuals_nas_annotationspasted.vcf
...
# paste annotations to table without annotations

paste -d '\t' c_ll_lp_plus_h_ll_polarized.lr_ann.ParentIDsGrep_noIndividuals_nas_noann_aainfoonly.vcf c_ll_lp_plus_h_ll_polarized.lr_ann.ParentIDsGrep_noIndividuals_nas_annotationspasted.vcf > c_ll_lp_plus_h_ll_polarized.lr_ann.ParentIDsGrep_squaredtable.vcf
...
sed 's/AA=//' c_ll_lp_plus_h_ll_polarized.lr_ann.ParentIDsGrep_squaredtable.vcf > tmp && mv tmp c_ll_lp_plus_h_ll_polarized.lr_ann.ParentIDsGrep_squaredtable.vcf
